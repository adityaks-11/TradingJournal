...
import { TrendingUp, LayoutDashboard, ListOrdered, Wallet, LogOut, Menu, X, Calendar, Layout } from 'lucide-react';
        ...
        <div className="md:hidden bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 py-2 transition-colors">
          <div className="container mx-auto px-4 space-y-2">
            ...
            <Link
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <Layout className="h-5 w-5 text-teal-600 dark:text-teal-500" />
              <span>Backtest</span>
            </Link>
